...
class User {
    ...
    //Função para atualizar o objeto do banco de dados
    public function  updateObject($id){
        //Para obtermos os dados do BD, Precisamos criar um objeto da classe Database
        $db = new Database();
        ...
        //Atualizar atributos do objeto conforme dados do BD
        ...
        //Agora retornaremos o objeto atualizado
        return $this;
    }
